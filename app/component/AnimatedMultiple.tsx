...
//     <div
//       className={cn(
//         "relative flex h-[400px] dark:bg-black w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl",
//         className,
//       )}
//       ref={containerRef}
//     >
...
//           <Circle ref={div7Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.user />
//           </Circle>
//         </div>
//         <div className="flex flex-col justify-center">
...
//           <Circle ref={div1Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.googleDrive />
//           </Circle>
//           <Circle ref={div2Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.googleDocs />
//           </Circle>
//           <Circle ref={div3Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.whatsapp />
//           </Circle>
//           <Circle ref={div4Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.messenger />
//           </Circle>
//           <Circle ref={div5Ref} className="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]">
//             <Icons.notion />
//           </Circle>
//         </div>
//       </div>
...
const Icons = {
  reddit: () => (
    ...
    >
      <path
        d="M22.073 10.966a2.676 2.676 0 00-4.558-1.884 13.488 13.488 0 00-6.015-1.758l1.273-5.993 4.181.979c.008.73.602 1.324 1.334 1.324.735 0 1.334-.597 1.334-1.334a1.332 1.332 0 00-2.583-.455l-4.767-1.115a.539.539 0 00-.651.407l-1.398 6.584a13.457 13.457 0 00-5.983 1.758 2.675 2.675 0 00-4.558 1.884 2.652 2.652 0 001.706 2.469c-.075.406-.113.824-.113 1.254C1.334 19.88 5.897 24 12 24s10.666-4.119 10.666-9.312c0-.43-.038-.848-.113-1.254a2.65 2.65 0 001.52-2.468zm-15.332 1.088c0-.982.795-1.776 1.777-1.776.982 0 1.777.794 1.777 1.776s-.795 1.776-1.777 1.776a1.777 1.777 0 01-1.777-1.776zm8.519 4.881c-1.547 1.547-5.949 1.547-7.496 0a.534.534 0 11.756-.756c1.099 1.099 4.885 1.099 5.984 0a.534.534 0 11.756.756zm-.741-3.105a1.777 1.777 0 110-3.553 1.777 1.777 0 010 3.553z"
        fill="#FF4500"
      />
    </svg>
  ),
  medium: () => (
    ...
    >
      <path
        d="M588.67 296.34c0 163.76-131.42 296.34-294.34 296.34S0 460.09 0 296.34 131.42 0 294.33 0s294.34 132.58 294.34 296.34zM1043.63 296.34c0 157.02-98.5 284.24-220 284.24s-220-127.22-220-284.24S701.12 12.1 823.64 12.1s220 127.21 220 284.24z"
        fill="#000"
      />
    </svg>
  ),
  googleForms: () => (
    ...
    >
      <path
        d="M34 6H20a2 2 0 00-2 2v32a2 2 0 002 2h16a2 2 0 002-2V12zm2 2.83L39.17 12H36z"
        fill="#4285F4"
      />
      <path
        d="M22 38h4v-2h-4zm0-6h4v-2h-4zm0-6h8v-2h-8zm0-6h8v-2h-8zm12 12h-2v2h2zm0-6h-2v2h2zm0-6h-2v2h2zm-4-6v10h6V14z"
        fill="#34A853"
      />
      <path
        d="M14 8H6a2 2 0 00-2 2v32a2 2 0 002 2h8V10a2 2 0 00-2-2z"
        fill="#EA4335"
      />
      <path d="M22 24h4v2h-4z" fill="#FBBC04" />
    </svg>
  ),
  discord: () => (
    <svg
    ...
    >
      <path
        d="M107.15 8.1A105.72 105.72 0 0092.19.33 72.44 72.44 0 0183.43 5.5c-3.16 1.44-6.22 3.05-9.17 4.73a93.34 93.34 0 00-27.4 0c-3-1.68-6.06-3.3-9.23-4.73A72.35 72.35 0 0134.96.33 105.84 105.84 0 0020 8.09c-19.77 28.87-25.16 57.1-22.42 85.06a101.74 101.74 0 0028.82 6.6c2.34-3.24 4.4-6.64 6.15-10.19a72.74 72.74 0 01-11.5-5.9c.95-.66 1.88-1.36 2.76-2.11 22.34 10.43 46.62 10.43 68.82 0 .93.75 1.87 1.45 2.83 2.11-3.7 2.34-7.5 4.5-11.48 5.9 1.77 3.54 3.81 6.95 6.15 10.19 10.3-.81 19.97-2.78 28.82-6.6 2.83-29.02-2.62-57.24-22.44-85.06zm-72.7 60.88c-5.78 0-10.48-5.33-10.48-11.85 0-6.52 4.7-11.84 10.48-11.84 5.8 0 10.48 5.33 10.48 11.84 0 6.52-4.68 11.85-10.48 11.85zm57.62 0c-5.78 0-10.48-5.33-10.48-11.85 0-6.52 4.7-11.84 10.48-11.84 5.8 0 10.48 5.33 10.48 11.84 0 6.52-4.68 11.85-10.48 11.85z"
        fill="#5865F2"
      />
    </svg>
  ),
  linkedin: () => (
    ...
    >
      <path
        d="M100 50C100 77.61 77.61 100 50 100S0 77.61 0 50 22.39 0 50 0s50 22.39 50 50z"
        fill="#0077B5"
      />
      <path
        d="M31.44 72.12h9.56V41.56h-9.56v30.56zm4.78-34.75c3.12 0 5.05-2.25 5.05-5.05s-2.06-5.05-5.18-5.05c-3.12 0-5.05 2.25-5.05 5.05s2.06 5.05 5.18 5.05zm32.25 34.75h9.56V57.44c0-7.62-3.88-11.12-9.05-11.12-4.18 0-6.05 2.25-7.18 3.88v-3.88h-9.56V72.12h9.56v-9.56c0-2.25 1.12-4.38 3.88-4.38s3.88 1.62 3.88 4.38v9.56z"
        fill="#fff"
      />
    </svg>
  ),
